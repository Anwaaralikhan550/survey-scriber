...
void main() {
  group('InspectionPhraseEngine - main walls repairs parity', () {
    const phraseTexts = <String, String>{
      ...
      '{E_MAIN_WALL_REPAIR}::{WALL_LINTEL_REPAIR_SOON}':
          'lintel opening={MAIN_WALL_REPAIR_LINTEL_OPENING_TO}; branch=soon; walls={MAIN_WALL_REPAIR_LINTEL_WALLS}; loc={MAIN_WALL_REPAIR_LINTEL_LOCATION}; defects={MAIN_WALL_REPAIR_LINTEL_DEFECT}',
      '{E_MAIN_WALL_REPAIR}::{WALL_LINTEL_REPAIR_NOW}':
          'lintel opening={MAIN_WALL_REPAIR_LINTEL_OPENING_TO}; branch=now; walls={MAIN_WALL_REPAIR_LINTEL_WALLS}; loc={MAIN_WALL_REPAIR_LINTEL_LOCATION}; defects={MAIN_WALL_REPAIR_LINTEL_DEFECT}',
    };
