...
export class SchedulingService {
        ...
        async (tx) => {
          ...
          return tx.booking.create({
            data: {
              ...
              notes: dto.notes,
              surveyType: dto.surveyType ?? 'home_survey',
              jobRef: dto.jobRef,
              ...
              estateAgentName: dto.estateAgentName,
              estateAgentPhone: dto.estateAgentPhone,
              estateAgentAddress: dto.estateAgentAddress,
              estateAgentNotes: dto.estateAgentNotes,
  ...
  private mapBookingToResponse(booking: any): BookingResponseDto {
    return {
      ...
      surveyType: booking.surveyType ?? undefined,
      jobRef: booking.jobRef ?? undefined,
      propertyType: booking.propertyType ?? undefined,
      yearBuilt: booking.yearBuilt ?? undefined,
      addressLine: booking.addressLine ?? undefined,
      city: booking.city ?? undefined,
      town: booking.town ?? undefined,
      postcode: booking.postcode ?? undefined,
      county: booking.county ?? undefined,
      accessType: booking.accessType ?? undefined,
      estateAgentName: booking.estateAgentName ?? undefined,
      estateAgentPhone: booking.estateAgentPhone ?? undefined,
      estateAgentAddress: booking.estateAgentAddress ?? undefined,
      estateAgentNotes: booking.estateAgentNotes ?? undefined,
